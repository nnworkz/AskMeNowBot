...
) : IProvider
{
    ...
    public async Task<bool> IsRegistered(long id)
    {
        ...
        await using var command = new NpgsqlCommand(queries[QueryName.IsRegistered], connection);
    ...
    public async Task<IUser> GetUser(long id)
    {
        ...
        await using var command = new NpgsqlCommand(queries[QueryName.GetUser], connection);
        command.Parameters.AddWithValue($"@{usersColumn.Id}", id);
    ...
    public async Task<bool> IsSubscriber(long userId)
    {
        ...
        await using var command = new NpgsqlCommand(queries[QueryName.IsSubscriber], connection);
    ...
    public async Task<ISubscriber> GetSubscriber(long userId)
    {
        ...
        await using var command = new NpgsqlCommand(queries[QueryName.GetSubscriber], connection);
    ...
    public async Task<bool> InWait(long senderId)
    {
        ...
        await using var command = new NpgsqlCommand(queries[QueryName.InWait], connection);
    ...
    public async Task<IWait> GetWait(long senderId)
    {
        ...
        await using var command = new NpgsqlCommand(queries[QueryName.GetWait], connection);
        command.Parameters.AddWithValue($"@{waitsColumn.SenderId}", senderId);
    ...
    public async Task<bool> IsBanned(long senderId, long recipientId)
    {
        ...
        await using var command = new NpgsqlCommand(queries[QueryName.IsBanned], connection);
    ...
    public async Task<IBan> GetBan(long senderId, long recipientId)
    {
        ...
        await using var command = new NpgsqlCommand(queries[QueryName.GetBan], connection);
        command.Parameters.AddWithValue($"@{bansColumn.SenderId}", senderId);
        command.Parameters.AddWithValue($"@{bansColumn.RecipientId}", recipientId);
    ...
    public async Task<bool> LinkExist(string link)
    {
        ...
        await using var command = new NpgsqlCommand(queries[QueryName.LinkExist], connection);
    ...
    public async Task<ILink> GetLink(string link)
    {
        ...
        await using var command = new NpgsqlCommand(queries[QueryName.GetLink], connection);
        command.Parameters.AddWithValue($"@{linksColumn.Link}", link);
    ...
    public async Task<List<ILink>> GetLinks(long userId)
    {
        ...
        await using var command = new NpgsqlCommand(queries[QueryName.GetLinks], connection);
    ...
    public async Task<List<ITransaction>> GetTransactions(long userId)
    {
        ...
        await using var command = new NpgsqlCommand(queries[QueryName.GetTransactions]);
    ...
    public async Task<IFilter> GetFilter(long userId)
    {
        ...
        await using var command = new NpgsqlCommand(queries[QueryName.GetFilter], connection);
