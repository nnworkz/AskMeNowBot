...
namespace AskMeNowBot.Database.PostgreSql;
...
) : IDatabase
{
    ...
    public async Task InitAsync()
    {
        ...
        try
        {
            ...
            {
                await using var command = new NpgsqlCommand(queries[query], connection, dbTransaction);
    ...
    public async Task AddUser(IUser user)
    {
        ...
        try
        {
            await using var command = new NpgsqlCommand(queries[QueryName.AddUser], connection, dbTransaction);
    ...
    public async Task RemoveUser(IUser user)
    {
        ...
        try
        {
            await using var command = new NpgsqlCommand(queries[QueryName.RemoveUser], connection, dbTransaction);
            command.Parameters.AddWithValue($"@{usersColumn.Id}", user.Id);
    ...
    public async Task AddSubscriber(ISubscriber subscriber)
    {
        ...
        try
        {
            await using var command = new NpgsqlCommand(queries[QueryName.AddSubscriber], connection, dbTransaction);
            var parameters = command.Parameters;
    ...
    public async Task RemoveSubscriber(ISubscriber subscriber)
    {
        ...
        try
        {
            await using var command = new NpgsqlCommand(queries[QueryName.RemoveSubscriber], connection, dbTransaction);
            var parameters = command.Parameters;
    ...
    public async Task AddWait(IWait wait)
    {
        ...
        try
        {
            await using var command = new NpgsqlCommand(queries[QueryName.AddWait], connection, dbTransaction);
            var parameters = command.Parameters;
    ...
    public async Task RemoveWait(IWait wait)
    {
        ...
        try
        {
            await using var command = new NpgsqlCommand(queries[QueryName.RemoveWait], connection, dbTransaction);
    ...
    public async Task AddBan(IBan ban)
    {
        ...
        try
        {
            await using var command = new NpgsqlCommand(queries[QueryName.AddBan], connection, dbTransaction);
            var parameters = command.Parameters;
    ...
    public async Task RemoveBan(IBan ban)
    {
        ...
        try
        {
            await using var command = new NpgsqlCommand(queries[QueryName.RemoveBan], connection, dbTransaction);
            var parameters = command.Parameters;
    ...
    public async Task AddLink(ILink link)
    {
        ...
        try
        {
            await using var command = new NpgsqlCommand(queries[QueryName.AddLink], connection, dbTransaction);
            var parameters = command.Parameters;
    ...
    public async Task RemoveLink(ILink link)
    {
        ...
        try
        {
            await using var command = new NpgsqlCommand(queries[QueryName.RemoveLink], connection, dbTransaction);
    ...
    public async Task AddTransaction(ITransaction transaction)
    {
        ...
        try
        {
            await using var command = new NpgsqlCommand(queries[QueryName.AddTransaction], connection, dbTransaction);
            var parameters = command.Parameters;
    ...
    public async Task AddFilter(IFilter filter)
    {
        ...
        try
        {
            await using var command = new NpgsqlCommand(queries[QueryName.AddFilter], connection);
            var parameters = command.Parameters;
    ...
    public async Task RemoveFilter(IFilter filter)
    {
        ...
        try
        {
            await using var command = new NpgsqlCommand(queries[QueryName.RemoveFilter], connection);
    ...
    private async Task<NpgsqlConnection> Connection()
    {
        return (NpgsqlConnection)await dataSource.OpenConnectionAsync(CancellationToken);
    }
}
